...
int rightMotor2 = 12;    // D6 - right Motor -
int rightMotor1 = 13;    // D7 - right Motor +
int leftMotor2 = 5;    // D1 - left Motor - 
int leftMotor1 = 4;    // D2 - left Motor +
int eneLeftMotor = 0;  // D3 - enable Mortor Left
int eneRightMotor = 2; // D4 - enable Mortor Right
int speed_left = 800;
int speed_right = 800;
...
{
  analogWrite(eneLeftMotor,speed_left);
  analogWrite(eneRightMotor,speed_right);
