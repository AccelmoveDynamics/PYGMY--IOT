...
const char* ssid = "enter your ssid(wifi name)";    // enter  Your Wi-Fi Name

const char* password = "enter your password";   // enter Wi-Fi Password
...
const int output5 = 5;// D1 pin
const int output4 = 16;// D0 pin
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<p>GPIO 16 - State " + output4State + "</p>");
