...
const char* ssid = "Your SSID (wifi name)Here"; //Your Network SSID

const char* password = "Your Password(wifi password) Here"; //Your Network Password
...
unsigned long myChannelNumber = YYYYYY; //Your Channel ID
